...
import { ButtonHTMLAttributes, forwardRef, ReactNode, ReactElement, isValidElement } from 'react';
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    if (asChild && isValidElement(children)) {
      const child = children as ReactElement<{ className?: string; ref?: React.Ref<any> }>;
